            ...
            <div className="flex flex-col h-full space-y-3">
                ...
                <div className="text-center space-y-1 flex-grow">
                    ...
                    <div className="space-y-1">
                        <p className="text-secondary text-xs">SKU: {stock.sku}</p>
                        <p className="text-accent font-medium text-sm">Stock: {stock.stock} units</p>
                    </div>
                </div>
                ...
                <div className="flex justify-between items-center py-1 border-t border-border">
                    ...
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${stock.stock > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
